...
import static me.hoonti06.deliverytracker.step0.DeliveryLastStatusSteps.배송상태_검증;
...
class LotteGlogisTrackedDeliveryTest {
  ...
  void get_delivered_status() {
    ...
    // then
    배송상태_검증(lastStatus, DeliveryStatus.COMPLETED, LocalDateTime.of(2023, 6, 20, 11, 6));
  }
}